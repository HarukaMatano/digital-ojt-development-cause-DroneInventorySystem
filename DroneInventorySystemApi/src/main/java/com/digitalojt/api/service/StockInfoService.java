...
public class StockInfoService {
    ...
    public List<StockInfo> searchStockInfo(String category, String name, Integer amount, String than) {
        return stockInfoRepository.findStockInfo(category, name, amount, than);
    }
}